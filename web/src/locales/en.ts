...
Example: Virtual Hosted Style`,
      ...
      sharepointDescription:
        'Connect a SharePoint site with app credentials and monitor one or more folders.',
      ...
      sharepointFolderPathsTip:
        'Optional. Add one or more SharePoint folders to monitor. Leave empty to crawl the site root. You can use site-relative paths such as "Shared Documents/Policies" or full SharePoint URLs.',
